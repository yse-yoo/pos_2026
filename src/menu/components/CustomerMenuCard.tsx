  ...
  return (
    <article className="grid grid-rows-[12rem_auto] overflow-hidden rounded-[1.1rem] border border-[#edf2ef] bg-white shadow-[0_10px_24px_rgba(15,23,42,0.04)]">
      ...
      <div className="relative flex items-center justify-center p-3">
        ...
        {soldOut && (
          <span className="absolute bottom-3 right-3 rounded-full bg-[rgba(255,17,17,0.78)] px-2.5 py-1 text-xs font-black text-white">
            売り切れ中
          </span>
        )}
      </div>
      ...
      <div className="flex flex-col gap-2 border-t border-[#edf2ef] p-4">
        ...
        <h2 className="m-0 min-h-[2.8em] text-base font-black leading-[1.4] text-[#334155]">
          {product.name}
        </h2>
